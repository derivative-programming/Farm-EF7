...
{
    internal class DateGreaterThanFilterProviderConfiguration
    {
        ...
        public static DateGreaterThanFilterProviderConfiguration GetConfig()
        {
            string sectionName = "FS.Farm" + "." + "DateGreaterThanFilterProvider";
            DateGreaterThanFilterProviderConfiguration result = null;
            if(ConfigurationManager.GetSection(sectionName) != null)
                result = (DateGreaterThanFilterProviderConfiguration)ConfigurationManager.GetSection(sectionName);
            ...
            if (result == null && System.IO.File.Exists(overrideConfig))
            {
                ...
                if (systemConfiguration.GetSection(sectionName) != null)
                {
                    ...
                    IConfigurationSectionHandler sectionHandler = new DateGreaterThanFilterProviderConfigurationHandler();
                    var xmlDocument = new XmlDocument();
                    xmlDocument.LoadXml(xml);
                    result = (DateGreaterThanFilterProviderConfiguration)sectionHandler.Create(null, null, xmlDocument.DocumentElement);
                }
            }
            return result;
        }
