...
{
    internal class DynaFlowTypeScheduleProviderConfiguration
    {
        ...
        public static DynaFlowTypeScheduleProviderConfiguration GetConfig()
        {
            string sectionName = "FS.Farm" + "." + "DynaFlowTypeScheduleProvider";
            DynaFlowTypeScheduleProviderConfiguration result = null;
            if(ConfigurationManager.GetSection(sectionName) != null)
                result = (DynaFlowTypeScheduleProviderConfiguration)ConfigurationManager.GetSection(sectionName);
            ...
            if (result == null && System.IO.File.Exists(overrideConfig))
            {
                ...
                if (systemConfiguration.GetSection(sectionName) != null)
                {
                    ...
                    IConfigurationSectionHandler sectionHandler = new DynaFlowTypeScheduleProviderConfigurationHandler();
                    var xmlDocument = new XmlDocument();
                    xmlDocument.LoadXml(xml);
                    result = (DynaFlowTypeScheduleProviderConfiguration)sectionHandler.Create(null, null, xmlDocument.DocumentElement);
                }
            }
            return result;
        }
