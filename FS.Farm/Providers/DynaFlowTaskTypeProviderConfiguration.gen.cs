...
{
    internal class DynaFlowTaskTypeProviderConfiguration
    {
        ...
        public static DynaFlowTaskTypeProviderConfiguration GetConfig()
        {
            string sectionName = "FS.Farm" + "." + "DynaFlowTaskTypeProvider";
            DynaFlowTaskTypeProviderConfiguration result = null;
            if(ConfigurationManager.GetSection(sectionName) != null)
                result = (DynaFlowTaskTypeProviderConfiguration)ConfigurationManager.GetSection(sectionName);
            ...
            if (result == null && System.IO.File.Exists(overrideConfig))
            {
                ...
                if (systemConfiguration.GetSection(sectionName) != null)
                {
                    ...
                    IConfigurationSectionHandler sectionHandler = new DynaFlowTaskTypeProviderConfigurationHandler();
                    var xmlDocument = new XmlDocument();
                    xmlDocument.LoadXml(xml);
                    result = (DynaFlowTaskTypeProviderConfiguration)sectionHandler.Create(null, null, xmlDocument.DocumentElement);
                }
            }
            return result;
        }
