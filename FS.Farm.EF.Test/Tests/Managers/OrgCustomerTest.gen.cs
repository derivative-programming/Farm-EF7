...
{
    [TestClass]
    public partial class OrgCustomerTest
    {
        [TestMethod]
        ...
        [TestMethod]
        public async Task GetMaxIdAsync_NoOrgCustomers_ShouldReturnZero()
        {
            var options = CreateSQLiteInMemoryDbContextOptions();
            using (var context = new FarmDbContext(options))
            {
        ...
        [TestMethod]
        public void GetMaxId_NoOrgCustomers_ShouldReturnZero()
        {
            var options = CreateSQLiteInMemoryDbContextOptions();
            using (var context = new FarmDbContext(options))
            {
