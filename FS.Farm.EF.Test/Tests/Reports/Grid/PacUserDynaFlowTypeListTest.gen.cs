...
{
    [TestClass]
    public class PacUserDynaFlowTypeListTest
    {
        ...
        public async Task GetCountAsync_ShouldReturnSingleCount()
        {
            ...
            using (var context = new FarmDbContext(options))
            {
                ...
                var reportGenerator = new PacUserDynaFlowTypeList(context);
                ...
                Guid contextCode = GetPacCode(context, dynaFlowType1);
        ...
        private Guid GetPacCode(FarmDbContext dbContext, FS.Farm.EF.Models.DynaFlowType dynaFlowType)
        {
            Dictionary<string,string> lineage = DynaFlowTypeFactory.GetCodeLineage(dbContext, dynaFlowType.Code.Value);
        ...
        private async Task<FS.Farm.EF.Models.DynaFlowType> CreateTestDynaFlowTypeAsync(FarmDbContext dbContext)
        {
            return await DynaFlowTypeFactory.CreateAsync(dbContext);
        }
        private FS.Farm.EF.Models.DynaFlowType CreateTestDynaFlowType(FarmDbContext dbContext)
        {
