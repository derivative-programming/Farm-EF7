...
{
    [TestClass]
    public class PacConfigDynaFlowTaskRunToDoListTest
    {
        ...
        public async Task GetCountAsync_ShouldReturnSingleCount()
        {
            ...
            using (var context = new FarmDbContext(options))
            {
                ...
                var reportGenerator = new PacConfigDynaFlowTaskRunToDoList(context);
                ...
                var resultCount = await reportGenerator.GetCountAsync(
                    null,   //isRunTaskDebugRequiredTriStateFilterCode
                    Guid.Empty,
