...
{
    public partial class DateGreaterThanFilterConfiguration : IEntityTypeConfiguration<DateGreaterThanFilter>
    {
         public void Configure(EntityTypeBuilder<DateGreaterThanFilter> builder)
        {
            builder.ToTable(ToSnakeCase("DateGreaterThanFilter"));
            //Int32 dayCount,
            //String description,
            //Int32 displayOrder,
            //Boolean isActive,
            ...
            builder.Property(p => p.LastChangeCode)
                .IsConcurrencyToken()
                .HasColumnName(ToSnakeCase(nameof(DateGreaterThanFilter.LastChangeCode)));
